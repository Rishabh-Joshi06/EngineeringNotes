...
public class MCH1  extends AppCompatActivity {
    private static final String TAG = "IT3";
    private String listview_array[]={"ENGINEERING MATHEMATICS-1","ENGINEERING MATHEMATICS-2","ENGINEERING CHEMISTRY","ENGINEERING PHYSICS","BASIC CIVIL ENGINEERING",
            "ENGINEERING GRAPHICS ","BASIC MECHANICAL ENGINEERING","BASIC ELECTRICAL AND ELECTRONICS ENGINEERING","BASIC COMPUTER ENGINEERING",
        ...
        myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i==0)
                {
                    ...
                    Intent intent=new Intent(MCH1.this, MATH1.class);
