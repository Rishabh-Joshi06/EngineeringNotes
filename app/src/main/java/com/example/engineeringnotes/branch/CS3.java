...
public class  CS3  extends AppCompatActivity {
    ...
    private String listview_array[]={"COMPUTER NETWORKS","DESIGN AND ANALYSIS OF ALGORITHMS","SOFTWARE ENGINEERING","HUMAN VALUES & ETHICS","THEORY OF COMPUTATION","CYBER ETHICS AND LAW",
        ...
        myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i==0)
                {
                    ...
                    Intent intent=new Intent(CS3.this, cn.class);
