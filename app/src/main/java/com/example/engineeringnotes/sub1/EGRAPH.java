package com.example.engineeringnotes.sub1;
...
public class EGRAPH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bcae);
        webView=findViewById(R.id.dpreswebview);
        displayWebView();
        bn=findViewById(R.id.dpresdownload);
