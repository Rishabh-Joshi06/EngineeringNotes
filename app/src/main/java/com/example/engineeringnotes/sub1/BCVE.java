...
public class BCVE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bcve);
        webView=findViewById(R.id.bcvewebview);
        displayWebView();
        bn=findViewById(R.id.bcvedownload);
