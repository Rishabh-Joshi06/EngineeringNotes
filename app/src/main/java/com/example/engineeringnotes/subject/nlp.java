...
public class nlp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView=findViewById(R.id.nlpwebview);
        displayWebView();
        bn=findViewById(R.id.nlpdownload);
        bn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent download = new Intent(Intent.ACTION_VIEW);
                String url ="https://drive.google.com/file/d/0BzZWzfHvSBRBV256cnVyelNaeUNRRHJEYnEtRU9vTE5rS1BJ/view?usp=sharing";
