...
public class AU2  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_au2);
        ...
        myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i==0)
                {
                    ...
                    Intent intent=new Intent(AU2.this, MATH3.class);
                ...
                {
                    Intent intent=new Intent(getApplicationContext(), SWLAB.class);
                    startActivity(intent);
                }
                else if (i==8)
                {
                ...
                {
                    Intent intent=new Intent(view.getContext(), MATERIALTECH.class);
                    startActivity(intent);
