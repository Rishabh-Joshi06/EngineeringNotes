...
public class CHEMY      extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chemy);
        webView=findViewById(R.id.chemywebview);
        displayWebView();
        bn=findViewById(R.id.chemydownload);
