...
import com.example.engineeringnotes.subcs2.CP2;
...
import com.example.engineeringnotes.subcs2.FUNDECOACC;
...
public class IT2  extends AppCompatActivity {
    ...
    private String listview_array[]={"DISCRETE MATHEMATICS","DATA STRUCTURE","COMPUTER ARCHITECTURE & ORGANIZATION",
            ...
            "COMPUTER PROGRAMMING-2","FUNDAMENTAL OF MANAGEMENT ,ECONOMICS AND ACCOUNTANCY"};
    ListView myList;
        ...
        myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i==0)
                {
                    ...
                    Intent intent=new Intent(IT2.this, DCMATH.class);
                ...
                {
                    Intent intent=new Intent(getApplicationContext(), FUNDECOACC.class);
                    startActivity(intent);
                }
